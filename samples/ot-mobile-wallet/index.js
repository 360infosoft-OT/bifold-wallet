...
import { OTWalletContainer } from './src/container-setup'

LogBox.ignoreAllLogs()

initLanguages(translationResources)
const bifoldContainer = new MainContainer(container.createChildContainer()).init()
const otWalletContainer = new OTWalletContainer(bifoldContainer).init()
const App = createApp(otWalletContainer)
